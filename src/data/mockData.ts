    ...
    data: [
      {
        ...
        title: 'Trip Update Confirmed',
        description: 'Your latest trip status update has been confirmed.',
    ...
    data: [
      {
        ...
        title: 'Checklist Review Needed',
        description: 'A submitted checklist needs your attention. Contact support.',
